    ...
    <div class="admin-themes">
      ...
      <main class="main-content">
        <div class="content-header">
          ...
          <div class="filters">
            <select name="statusFilter" [(ngModel)]="statusFilter" (change)="filterThemes()" class="filter-select">
        ...
        <div *ngIf="!loading && themes.length > 0" class="themes-grid">
          <div *ngFor="let theme of filteredThemes" class="theme-card" [class]="'status-' + theme.status">
...
export class AdminThemesComponent implements OnInit {
    ...
    filterThemes() {
        if (!this.statusFilter) {
            ...
            this.filteredThemes = this.themes.filter(theme => theme.status === this.statusFilter);
        }
    }
